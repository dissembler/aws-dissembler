...
import (
	...
	cachev1alpha1 "github.com/temp/aws-dissembler/pkg/apis/cache/v1alpha1"
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileS3{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &cachev1alpha1.S3{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create that are owned by the primary resource
	// Watch for changes to secondary resource Pods and requeue the owner S3
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &cachev1alpha1.S3{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileS3) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set S3 instance as the owner and controller
...
func newPodForCR(cr *cachev1alpha1.S3) *corev1.Pod {
